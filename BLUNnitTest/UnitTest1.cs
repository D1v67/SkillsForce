        ...
        public void Setup()
        {
            _accounts = new List<AccountModel>()
            {
                new AccountModel()
                {
                    ...
                    Password = "admin",
                    HashedPassword = ConvertHexStringToByteArray("0xA394723EBCF1BE4F32E1A9BE7F396CB19C26924913EAB2FB47CD1219B1A59E5D"),
                    SaltValue = ConvertHexStringToByteArray("0x645C8A074930444D00A159A7022A70A2")
                }
            };
